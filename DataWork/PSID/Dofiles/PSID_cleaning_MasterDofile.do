   ...
   * ******************************************************************** *
   *                                                                      *
   *               PSID CLEANING MASTER DO_FILE                           *
   *               This master dofile calls all dofiles related           *
   *               to cleaning in the PSID round.                         *
   *                                                                      *
   * ******************************************************************** *
   * ******************************************************************** *
   ...
   * ***************************************************** *
       ...
       *do "$PSID_doCln/dofile2.do" //Give your dofile a more informative name, this is just a placeholder name
   ...
   * ***************************************************** *
       ...
       *do "$PSID_doCln/dofile3.do" //Give your dofile a more informative name, this is just a placeholder name
