   ...
   * ******************************************************************** *
   *                                                                      *
   *               PSID ANALYSIS MASTER DO_FILE                           *
   *               This master dofile calls all dofiles related           *
   *               to analysis in the PSID round.                         *
   *                                                                      *
   * ******************************************************************** *
   * ******************************************************************** *
   ...
   * ***************************************************** *
       ...
       *do "$PSID_doAnl/dofile2.do" //Give your dofile a more informative name, this is just a placeholder name
   ...
   * ***************************************************** *
       ...
       *do "$PSID_doAnl/dofile3.do" //Give your dofile a more informative name, this is just a placeholder name
