   ...
   * ******************************************************************** *
   *                                                                      *
   *               CPS IMPORT MASTER DO_FILE                              *
   *               This master dofile calls all dofiles related           *
   *               to import in the CPS round.                            *
   *                                                                      *
   * ******************************************************************** *
   * ******************************************************************** *
   ...
   * ***************************************************** *
       ...
       *do "$CPS_doImp/dofile1.do" //Give your dofile a more informative name, this is just a placeholder name
   ...
   * ***************************************************** *
       ...
       *do "$CPS_doImp/dofile2.do" //Give your dofile a more informative name, this is just a placeholder name
   ...
   * ***************************************************** *
       ...
       *do "$CPS_doImp/dofile3.do" //Give your dofile a more informative name, this is just a placeholder name
