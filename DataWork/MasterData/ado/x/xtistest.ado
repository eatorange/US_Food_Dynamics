...
program define xtistest, rclass
	...
	** Print header
	if "`postEstimation'" == "" di as result _newline "Inoue and Solon (2006) LM-test on variables `varlist'"
	else						di as result _newline "Inoue and Solon (2006) LM-test as postestimation"
