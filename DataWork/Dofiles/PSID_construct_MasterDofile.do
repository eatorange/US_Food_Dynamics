   ...
   * ******************************************************************** *
   *                                                                      *
   *               PSID CONSTRUCT MASTER DO_FILE                          *
   *               This master dofile calls all dofiles related           *
   *               to construct in the PSID round.                        *
   *                                                                      *
   * ******************************************************************** *
   * ******************************************************************** *
   ...
   * ***************************************************** *
       ...
       *do "$PSID_doCon/dofile2.do" //Give your dofile a more informative name, this is just a placeholder name
   ...
   * ***************************************************** *
       ...
       *do "$PSID_doCon/dofile3.do" //Give your dofile a more informative name, this is just a placeholder name
