...

		{
			...
			*	Figure B1
			preserve
				...
				*	Figure B1 (Spell Length of Food Insecurity (2003-2015))
		...
		
		{
			...
			*	2 X 2 (FS, FI)	-	FS status over two subsequent periods
				...
				*	Year
				...
				forvalues	year=3/10	{			
					...
					*	Change in Status (Prepare Fig B2)
			...
			*	Need to plot from matrix, thus create a temporary dataset to do this
			preserve
				...
				*	Figure B3
				*	Since the AJAE editor required to use B&W with patterns which Stata does NOT support, I export data to "Fig_B3.xlsx" which generates graphs there.
				*	Note that Excel does generate B3a and B3b only. I (Seungmin) manually combined Figure B3 by combining B3a and B3b
					mat	colnames	FI_newly_year_all	=	2003 2005 2007 2009 2011 2013 2015 2017
					mat	rownames	FI_newly_year_all	=	"HS/Non-White/Female (3.8%)"	"HS/Non-White/Male (3.0%)"	"HS/White/Female (5.7%)" 	"HS/White/Male (24.2%)"	///
															"Col/Non-White/Female (2.4%)"	"Col/Non-White/Male (5.0%)"	"Col/White/Female (10.1%)"	"Col/White/Male (45.1%)"
					mat	colnames	FI_still_year_all	=	2003 2005 2007 2009 2011 2013 2015 2017
					mat	rownames	FI_still_year_all	=	"HS/Non-White/Female (3.8%)"	"HS/Non-White/Male (3.0%)"	"HS/White/Female (5.7%)" 	"HS/White/Male (24.2%)"	///
															"Col/Non-White/Female (2.4%)"	"Col/Non-White/Male (5.0%)"	"Col/White/Female (10.1%)"	"Col/White/Male (45.1%)"
					mat	rownames	Pop_ratio			=	"HS/Non-White/Female (3.8%)"	"HS/Non-White/Male (3.0%)"	"HS/White/Female (5.7%)" 	"HS/White/Male (24.2%)"	///
															"Col/Non-White/Female (2.4%)"	"Col/Non-White/Male (5.0%)"	"Col/White/Female (10.1%)"	"Col/White/Male (45.1%)"
															
					putexcel	set "${FSD_outFig}/Fig_B3", sheet(Fig_B3) modify /*replace*/
					...
					putexcel	A46	=	matrix(Pop_ratio), names overwritefmt nformat(number_d1)		//	population ratio in the figure
						
					
					*	Directly generated by Stata (no longer used)
					/*
					{
					*	left panel
			...
			*	Descriptive stats
				...
				*	Fig B4
				preserve
					...
					label	define	edu_fig5	1	"Less than High School (1.9%)"	2	"High School (2.3%)"	3	"Some College (1.3%)"	4	"College (0.6%)"	///
												5	"Less than High School (0.8%)"	6	"High School (2.6%)"	7	"Some College (2.6%)"	8	"College (1.8%)"	///
												9	"Less than High School (1.5%)"	10	"High School (5.1%)"	11	"Some College (4.4%)"	12	"College (4.0%)"		///
												13	"Less than High School (4.7%)"	14	"High School (20.5%)"	15	"Some College (16.0%)"	16	"College (26.7%)",	replace
					label	values	edu_fig5	edu_fig5
					list	edu_fig5		pop_ratio	//	Population ratio in the figure
		   ...
		   *	Total population size, which is needed to get the share of each sub-group population to total population later
			...
			*	Figure B6
			preserve
				...
				*	Generate category variable 				
				...
				//	Currently we use the value for the proportion of each category from the pre-calculated value. It would be better if we can automatically update it as analyses are updated.
				label	define	fig7_cat	1	"NoHS/NonWhite/Female (1.6%)"		2	"NoHS/NonWhite/Male (0.8%)"		3	"NoHS/White/Female (1.2%)"		4	"NoHS/White/Male (4.0%)"	///
											5	"HS/NonWhite/Female (2.4%)"			6	"HS/NonWhite/Male (2.5%)"		7	"HS/White/Female (4.9%)"		8	"HS/White/Male (20.5%)"	///
											9	"SomeCol/NonWhite/Female (1.3%)"	10	"SomeCol/NonWhite/Male (2.6%)"	11	"SomeCol/White/Female (4.9%)"	12	"SomeCol/White/Male (15.5%)"		///
											13	"Sol/NonWhite/Female (0.9%)"		14	"Col/NonWhite/Male (2.1%)"		15	"Col/White/Female (4.3%)"		16	"Col/White/Male (28.6%)",	replace
				label	values	fig7_cat	fig7_cat
				list	fig7_cat	pop_ratio	//	population ratio in the figure
				...
				*	Generate the difference in HCR and SFIG between the most insecure and the most secure group (in-text number)
				...
				di "`ratio_HCR_insecure_to_secure'"	//	5.08
				...
				di "`ratio_SFIG_insecure_to_secure'"	//	7.42
				
				*	Figure B6	(Food Insecurity Prevalence and Severity by Group)
			...
			*	Thus we export the data to Excel and generate the graph with Excel.
				...
				*	Note that Excel does generate 3a and 3b only. I (Seungmin) manually combined Figure 3 by combining 3a and 3b
					...
					mat	rownames	HCR_weight_cat_all	=	"HS/Non-White/Female (4.1%)"	"HS/Non-White/Male (3.3%)"	"HS/White/Female (6.0%)" 	"HS/White/Male (24.5%)"	///
															"Col/Non-White/Female (2.2%)"	"Col/Non-White/Male (4.7%)"	"Col/White/Female (9.3%)"	"Col/White/Male (44.0%)"
					
					mat	colnames	FIG_weight_cat_all	=	2001 2003 2005 2007 2009 2011 2013 2015 2017
					mat	rownames	FIG_weight_cat_all	=	"HS/Non-White/Female (4.1%)"	"HS/Non-White/Male (3.3%)"	"HS/White/Female (6.0%)" 	"HS/White/Male (24.5%)"	///
															"Col/Non-White/Female (2.2%)"	"Col/Non-White/Male (4.7%)"	"Col/White/Female (9.3%)"	"Col/White/Male (44.0%)"
					
					mat	colnames	SFIG_weight_cat_all	=	2001 2003 2005 2007 2009 2011 2013 2015 2017
					mat	rownames	SFIG_weight_cat_all	=	"HS/Non-White/Female (4.1%)"	"HS/Non-White/Male (3.3%)"	"HS/White/Female (6.0%)" 	"HS/White/Male (24.5%)"	///
															"Col/Non-White/Female (2.2%)"	"Col/Non-White/Male (4.7%)"	"Col/White/Female (9.3%)"	"Col/White/Male (44.0%)"
					
					mat	rownames	Pop_ratio_all		=	"HS/Non-White/Female (4.1%)"	"HS/Non-White/Male (3.3%)"	"HS/White/Female (6.0%)" 	"HS/White/Male (24.5%)"	///
															"Col/Non-White/Female (2.2%)"	"Col/Non-White/Male (4.7%)"	"Col/White/Female (9.3%)"	"Col/White/Male (44.0%)"
