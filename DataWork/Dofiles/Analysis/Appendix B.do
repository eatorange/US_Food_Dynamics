		...
		
		{
			...
			*	Need to plot from matrix, thus create a temporary dataset to do this
			preserve
				...
				*	Figure B3
				*	Since the editor required to use B&W with patterns which Stata does NOT support, I export data to "Fig_B3.xlsx" which generates graphs there.
				*	Note that Excel does generate B3a and B3b only. I (Seungmin) manually combined Figure B3 by combining B3a and B3b
					...
					putexcel	A46	=	matrix(Pop_ratio), names overwritefmt nformat(number_d1)		
